...
evaluation_plot_score_df %>% 
  ...
  dplyr::mutate(
    ...
    , rmse_height_m = scales::comma(rmse_height_m,accuracy=0.1)
  ) %>% 
...
plt_fn <- function(
    ...
    , my_evaluation_ground_truth_crowns_df = evaluation_ground_truth_crowns_df
    , my_evaluation_ground_truth_crown_match_df = evaluation_ground_truth_crown_match_df
    , my_fi_evaluation_submission = fi_evaluation_submission
  ...
  ggplot2::ggplot(mapping = ggplot2::aes(fill = match_grp, color = match_grp)) +
    ...
    ggplot2::guides(
      fill = ggplot2::guide_legend(override.aes = list(color = c(my_pal_match_grp["commission"],NA,NA)))
      , color = "none"
    )
}
plt_fn(3)
