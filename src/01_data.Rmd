...
there are some plotting functions

```{r}
# Generate plots for fuels LAD metrics
plots_cbh_maxlad <- LadderFuelsR::get_plots_cbh_LAD(lad_profile, cbh_metrics, min_height=1.5)
plots_cbh_maxdist <- LadderFuelsR::get_plots_cbh_maxdist(lad_profile, cbh_metrics, min_height=1.5)
plots_cbh_lastdist <- LadderFuelsR::get_plots_cbh_lastdist(lad_profile, cbh_metrics, min_height=1.5)
# patchwork them
plots_cbh_maxlad[[1]] +
  plots_cbh_maxdist[[1]] +
