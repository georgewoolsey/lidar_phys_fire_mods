...
* to get around the image service data limits, aggregate the raster to 90x90 m resolution in chunks
    ...
    + export the raster layer as a .tiff
    + repeat for chunk 2 in the "Environments" tab change the extent (t,l,r,b): 6868893.686445,-10383464.5467503,-7114771.213417,2480613.686445
    + mosaic the chunks
...
foresttype <- 
  ...
  terra::rast("../data/foresttype/foresttype.tiff")
# what?
foresttype
# layers?
