...
remove(foresttype, foresttype_lookup)
gc()
```
...
trees_species <- function(
  ...
  ##################################
  # fill na values in the raster using nearest neighbor
  ##################################
    foresttype_temp <- fill_rast_na(foresttype_temp)
...
```{r}
trees_species_ans <- trees_species(
  cloud2trees_ans$treetops_sf
  , input_foresttype_dir = "E:\\lidar_phys_fire_mods\\data\\"
)
# ?what?
...
let's put this in to `cloud2trees`
